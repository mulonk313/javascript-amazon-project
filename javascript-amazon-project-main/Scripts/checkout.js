...
cart.forEach((cartItem) => {
    ...
    const today = dayjs();
    const deliverydDate = today.add(
        deliveryOption.deliveryDays,
        'days'
    );
    const dateString = deliverydDate.format(
        'dddd, MMMM, D'
    );
    ...
    cartSummaryHTML += `<div class="cart-item-container js-cart-item-container-${matchingProduct.id}">
        ...
        <div class="cart-item-details-grid">
            ...
            <div class="product-quantity">
                ...
                <span class="validation-message js-validation-message">
                Update number must be between 0 and 1000.
                </span>
            </div>
            </div>
...
function deliveryOptionsHTML (matchingProduct, cartItem) {
    ...
    deliveryOptions.forEach((deliveryOption) => {
        ...
        html += `
            <div class="delivery-option js-delivery js-delivery-option" 
...
document.querySelectorAll('.js-save-link').forEach((link) => {
    ...
    const saveFunction = () => {
        ...
        const afterUpdateValue = document.querySelector('js-quantity-input');
